...
#include "BullCowCartridge3.h"
#include "HiddenWordList.h"
// #include "Math/UnrealMathUtility.h"

/*=================================== BeginPlay ======================================== */

;void UBullCowCartridge3:: BeginPlay()
{
    Super:: BeginPlay();
};
...
void UBullCowCartridge3::OnInput(const FString& PlayerInput) // When the player hits enter
{
    if (bGameOver)
    {
        ClearScreen();
...
void UBullCowCartridge3::SetUpGame()
{
    // welcome the player
...
void UBullCowCartridge3::EndGame()
{   
    bGameOver = true;
...
void UBullCowCartridge3::ProcessGuess(const FString& Guess)
{
...
bool UBullCowCartridge3::IsIsogram(const FString& Word) const 
{
...
TArray<FString> UBullCowCartridge3::GetValidWords(const TArray<FString>& WordList) const
{
...
FBullCowCount UBullCowCartridge3::GetBullCows(const FString& Guess) const
{
    FBullCowCount Count;
